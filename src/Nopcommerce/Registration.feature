Feature: Nopcommerce Registration
  ...
  Background: I am on Nopcommerce Registration page
    ...
    When      I open the URL https://nopcommerce.com/register
    ...
    Scenario Outline: I should not be able to register with invalid data on mandatory field(*) of registration page
      ...
      Examples:      | First Name |Last Name|      Email     |Password|Confirm Password|               error message             |
                     ...
                     |Rahul       |         |bakshi@gmail.com|456897  |456897          |Please Enter Last name                   |
                     |Rahul       |bakshi   |                |456897  |456897          |Please Enter Email Id                    |
                     |Rahul       |bakshi   |bakshi@gmail.com|        |456897          |Please Enter Password                    |
                     |Rahul       |bakshi   |bakshi@gmail.com|456897  |                |Please Enter Confirm Password            |
                     |Rahul       |bakshi   |bakshi@gmail.com|456897  |456789          |Password and confirm password not matched|
                     |Rahul       |bakshi   |bakshi@gmail.com|        |                |Minimum 6 character password is required |
    ...
    Scenario:        I should be able to check and uncheck the Newsletter box on option section
      ...
      Then           I was able to check and uncheck the box next to Newsletter
