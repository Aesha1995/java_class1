Feature: Book category
  ...
  Background:         I should be able to see homepage
    ...
    Scenario Outline: I should be able to choose any filter option with specific result
      ...
      Then            I should be able to see choose any filter option from the list
    ...
    Scenario Outline: I should be able to see product display format according display format type as per given picture in SRS document
      ...
      Then            I should be able to see product dipslay format according display format as per given picture in SRS document
